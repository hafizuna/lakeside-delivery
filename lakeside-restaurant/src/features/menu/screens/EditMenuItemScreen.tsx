...
import { ArrowBackIcon, ChevronDownIcon, TrashIcon } from '../../../shared/components/CustomIcons';
    ...
    >
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.section}>
          ...
          >
            <TrashIcon size={20} color={deleting ? Colors.text.disabled : Colors.error.main} />
