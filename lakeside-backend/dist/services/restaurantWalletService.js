...
class RestaurantWalletServiceImpl {
    /**
     * Get or create restaurant wallet
     */
    async getOrCreateWallet(restaurantId) {
        try {
     ...
     */
    async addRestaurantEarning(restaurantId, orderTotal, commission, orderId) {
        try {
     ...
     */
    async getWalletBalance(restaurantId) {
        try {
     ...
     */
    async getWalletTransactions(restaurantId, limit = 50) {
        try {
...
exports.default = restaurantWalletService;
//# sourceMappingURL=restaurantWalletService.js.map