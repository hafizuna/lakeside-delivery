...
class MaintenanceService {
     ...
     */
    async validateDriverStateConsistency() {
        try {
     ...
     */
    async validateActiveAssignmentCounts() {
        try {
    ...
    async getSystemHealth() {
        try {
            const [totalDrivers, onlineDrivers, activeAssignments, pendingOffers, expiredOffers, totalOrders, ordersNeedingDrivers] = await Promise.all([
