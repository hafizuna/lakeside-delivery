 ...
 */
export const toggleMenuItemAvailability = async (req: AuthenticatedRequest, res: Response) => {
  try {
    const userId = req.user?.id;
    const { id } = req.params;
 ...
 */
export const bulkUpdateCategory = async (req: AuthenticatedRequest, res: Response) => {
  try {
    const userId = req.user?.id;
 ...
 */
export const bulkUpdatePrice = async (req: AuthenticatedRequest, res: Response) => {
  try {
    const userId = req.user?.id;
 ...
 */
export const bulkDeleteMenuItems = async (req: AuthenticatedRequest, res: Response) => {
  try {
    const userId = req.user?.id;
