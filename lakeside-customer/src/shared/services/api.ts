...
export const restaurantAPI = {
  async getRestaurants(params?: {
    ...
    limit?: number;
    offset?: number;
  }): Promise<{ success: boolean; data: Restaurant[]; total: number }> {
    try {
...
export const ratingAPI = {
  ...
  async checkRating(
    type: "restaurant" | "order" | "driver",
    targetId: number
  ): Promise<{ success: boolean; data: { hasRated: boolean; rating: any } }> {
    try {
